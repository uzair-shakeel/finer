...
const Filters = ({ label, type = "list", options, onSelect }) => {
     ...
     return (
          <div className="inline-block w-full md:w-auto" ref={dropdownRef}>
               <button
                    ...
                    className={`flex items-center text-nowrap justify-between gap-2.5 w-full md:w-auto px-6 min-h-[37px] text-[16px] leading-[19px] font-normal rounded-[30px] ${isOpen ? "bg-[#017EFE] text-white" : "bg-white text-black"
                         }`}
               >
