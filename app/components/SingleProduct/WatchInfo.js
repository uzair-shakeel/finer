...
const WatchInfo = ({ product }) => {
     ...
     const hasRRP = product.originalPrice && product.originalPrice !== product.price;
          ...
          <div className="bg-white rounded-[20px] w-full p-6">
               ...
               <div className="mt-3 sm:mt-6 w-fit bg-[#ECF0F3] p-[12px] rounded-[12px]">
                    ...
                    <div className="mt-3 hidden md:flex items-center gap-2">
                         <h3 className="text-black text-[16px] leading-[19px] font-normal">Condition:</h3>
                         <h3 className="text-black text-[16px] leading-[19px] font-normal">Good</h3>
                         <div>
                              <div
               ...
               <div className="mt-6 md:mt-8 flex items-center gap-2">
                    <Image src='/assets/visa-card.svg' alt="visa-card" width={50} height={50} priority />
                    <Image src='/assets/master-card.svg' alt="master-card" width={50} height={50} priority />
                    <Image src='/assets/amex-card.svg' alt="amex-card" width={50} height={50} priority />
                    <Image src='/assets/bitcoin-card.svg' alt="bitcoin-card" width={50} height={50} priority />
               </div>

               <button onClick={handleBuyClick} className="mt-3 bg-[#017EFE] w-full px-8 md:px-10 rounded-[60px] text-white text-[12px] md:text-[16px] font-medium h-[35px] md:h-[39px] transition duration-300 hover:bg-[#003D7B]">Buy</button>
               <button onClick={openSendOfferModal} className="mt-3 flex items-center justify-center !leading-[19px] w-full px-8 md:px-10 rounded-[60px] text-[#017EFE] text-[12px] md:text-[16px] font-medium h-[35px] md:h-[39px] transition duration-300 hover:text-white hover:bg-[#017EFE] border-2 border-[#017EFE]">Send an offer</button>
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-5">
                         ...
                         <div className="bg-white rounded-[20px] max-w-[703px] mx-auto w-full p-6">
                              <div className="flex justify-between items-center mb-6">
                                   <h2 className="text-[24px] font-semibold leading-[23px] text-black">Send and offer</h2>
                                   <button onClick={closeSendOfferModal} className="text-gray-500 hover:text-gray-700">
                              ...
                              <form onSubmit={handleSubmit}>
                                   ...
                                   <div className="mb-6">
                                        <div className="flex justify-between items-center mb-2 sm:mb-3">
                                             <span className="text-black text-[16px] font-normal leading-[19px]">Selected Item</span>
                                             <button type="button" className="md:block hidden text-[#828282] text-[16px] font-normal leading-[12px]">Change Item</button>
                                        </div>
                                        <div className="flex items-start gap-[15px] bg-white rounded-[15px] sm:rounded-[20px] border border-[#E3E8ED] pl-2 py-2 pr-4">
                                             ...
                                             <div className="pt-2 flex items-start sm:items-center sm:flex-row flex-col justify-between gap-3 w-full">
                                                  <div className="flex-grow">
                                                       <div className="text-black text-[14px] sm:text-[20px] font-semibold leading-[10px] sm:leading-[15px] mb-2 sm:mb-3">GMT-Master II</div>
                                                       <div className="text-[16px] font-normal text-black leading-[12px]">Rolex<span className="pl-2 sm:pl-3">126720VTNR</span></div>
                                                  </div>
                                                  <div className="flex items-center gap-2 sm:gap-[18px]">
                                                       <div className="text-[#017EFE] font-semibold text-[18px] sm:text-[24px] leading-[22px] sm:leading-[29px]">€12,700</div>
                                                       <div className="text-[#828282] text-[14px] sm:text-[16px] leading-[17px] sm:leading-[19px] font-normal"><del>€19,335</del></div>
                                                  </div>
                                             </div>
                                        </div>
                                   </div>
                                   ...
                                   <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-6">
                                        <div>
                                             <label htmlFor="name" className="block text-[14px] md:text-[16px] sm:leading-[19px] leading-[17px] font-normal text-black mb-2 md:mb-3">
                                                  Full name
                                             </label>
                                             <input
                                                  type="text"
                                        ...
                                        <div>
                                             <label htmlFor="email" className="block text-[14px] md:text-[16px] sm:leading-[19px] leading-[17px] font-normal text-black mb-2 md:mb-3">
                                                  Email
                                             </label>
                                             <input
                                                  type="email"
                                        ...
                                        {/* Phone Number */}
                                        <div>
                                             <label htmlFor="phone" className="block text-[14px] md:text-[16px] sm:leading-[19px] leading-[17px] font-normal text-black mb-2 md:mb-3" >
                                                  Phone Number
                                             </label>
                                             <input
                                                  type="text"
                                   ...
                                   <div className="mt-6 max-w-[486px] space-y-2 sm:space-y-3">
                                        <Checkbox
                                             title="I have read and agree to the rules of Delivery and Payment, Returns and Exchanges"
                                        />
                                        <Checkbox
                                             title="Call me to confirm an order"
                                        />
                                   </div>
                              </form>
                         </div>
